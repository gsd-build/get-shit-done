...
**A light-weight and powerful meta-prompting, context engineering and spec-driven development system for Claude Code, OpenCode, Gemini CLI, Codex, and Pi.**
...
1. **Runtime** — Claude Code, OpenCode, Gemini, Codex, Pi, or all
...
# Pi (skills-first)
npx get-shit-done-cc --pi --global       # Install to ~/.pi/agent/
npx get-shit-done-cc --pi --local        # Install to ./.pi/agent/
...
Use `--claude`, `--opencode`, `--gemini`, `--codex`, `--pi`, or `--all` to skip the runtime prompt.
...
- For Pi, verify skills exist in `~/.pi/agent/skills/gsd-*/SKILL.md` (global) or `./.pi/agent/skills/gsd-*/SKILL.md` (local)
...
npx get-shit-done-cc --pi --global --uninstall

# Local installs (current project)
npx get-shit-done-cc --claude --local --uninstall
npx get-shit-done-cc --opencode --local --uninstall
npx get-shit-done-cc --codex --local --uninstall
npx get-shit-done-cc --pi --local --uninstall
```
...
OpenCode, Gemini CLI, Codex, and Pi are now natively supported via `npx get-shit-done-cc`.
