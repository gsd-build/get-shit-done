...
## The Codebase Intelligence Lesson

What happened:
1. Large feature merged directly to main
2. Added 21MB dependency, complex SQLite graph database
3. Discovered overengineering after merge
4. Public revert required

What should happen:
1. Large feature goes in `feat/codebase-intelligence` branch
2. PR opened for review
3. Discussion: "21MB dependency seems heavy"
4. PR closed or redesigned
5. No public revert needed

**Rule:** If a feature touches >500 lines or adds dependencies, use a branch and PR.
