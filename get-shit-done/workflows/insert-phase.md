...
Extract from init JSON: `state_path`, `roadmap_path`, `phase_dir`, `planning_base`.
...
- Creating the phase directory (`{planning_base}/phases/{N.M}-{slug}/`)
...
- Directory: {planning_base}/phases/{decimal-phase}-{slug}/
