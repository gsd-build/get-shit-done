...
See ~/.claude/get-shit-done/templates/discovery.org `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/get-shit-done/templates/discovery.org structure:
...
1. **Scope the discovery** using ~/.claude/get-shit-done/templates/discovery.org:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/get-shit-done/templates/discovery.org
...
Use ~/.claude/get-shit-done/templates/discovery.org.
