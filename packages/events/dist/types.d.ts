...
export declare const EVENTS: {
    ...
    readonly AGENT_PHASE: "agent:phase";
    readonly TOOL_START: "agent:tool_start";
    readonly TOOL_END: "agent:tool_end";
    readonly CHECKPOINT_REQUEST: "checkpoint:request";
    readonly CHECKPOINT_RESPONSE: "checkpoint:response";
    readonly CONNECTION_HEALTH: "connection:health";
};
