...
| `perplexity.cjs` | Perplexity Search and Agent API client: resolves API keys, adds integration attribution headers, normalizes responses, and returns graceful no-key fallbacks |
